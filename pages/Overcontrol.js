    ...
    <PageContainer isVisible={isVisible}>
      ...
      <main>
        <Root>
          ...
          <MainTitle>과잉통제형에 해당할 확률이 높아요!</MainTitle>
          <SubDesc>
            과잉 통제형은 실수를 줄이고 상황을 스스로 완벽하게 관리하려는 경향이 강합니다.
            <br />
            이런 성향은 긴장을 풀면서도 통제감을 유지하려는 특징으로 나타나며, <span style={{ color: '#707070', fontWeight: '700' }}>손가락 관절 꺾기</span> 같은
            <br />
            반복 행동으로 이어지며 이는 순간적으로 긴장을 해소하고 통제감을 확인하려는 방식입니다.
          </SubDesc>
          <UserDesc>
