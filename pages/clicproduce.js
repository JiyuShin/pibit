...
export default function ClicProducePage() {
    ...
    useEffect(() => {
        if (router.isReady) {
            ...
            console.log('클릭워크 프로듀스 페이지 - 받은 값들:', { name, selectedHabits, finalHabit, fullQuery: router.query });
            setActualName(name);
        }
    ...
    const fullText1 = `안녕! 만나서 반가워, 난 ${actualName ? `${actualName}가` : '당신이'} 나를 똑딱 눌러줄\n때마다 속 시원한 재미를 톡톡 터뜨리는\n장난스럽고 쾌활한 존재야!`;
    ...
    return (
        <>
            <Head>
                <title>PIBIT - Clickwork Produce</title>
            ...
            <Root>
                ...
                <ModelContainer show={showModel}>
                    <FlowerModelView onModelClick={handleStartConversation} modelPath="/clic22.glb"/>
                </ModelContainer>
                
                <ContainerLoader show={showLoader}>
                    <Ball style={{"--color": "#4169E1", "--i": "13px", "--d": "6.8s"}} />
                    <Ball style={{"--color": "#0000FF", "--i": "19px", "--d": "3.5s"}} />
                    <Ball style={{"--color": "#1E90FF", "--i": "11px", "--d": "4.9s"}} />
                    <Ball style={{"--color": "#00BFFF", "--i": "17px", "--d": "9.3s"}} />
                    <Ball style={{"--color": "#87CEEB", "--i": "14px", "--d": "2.7s"}} />
                    <Ball style={{"--color": "#87CEFA", "--i": "10px", "--d": "5.1s"}} />
                    <Ball style={{"--color": "#ADD8E6", "--i": "16px", "--d": "6.6s"}} />
                    <Ball style={{"--color": "#B0C4DE", "--i": "18px", "--d": "7.2s"}} />
                    <Ball style={{"--color": "#6495ED", "--i": "12px", "--d": "8.4s"}} />
                    <Ball style={{"--color": "#4682B4", "--i": "20px", "--d": "3.9s"}} />
                    <Ball style={{"--color": "#5F9EA0", "--i": "15px", "--d": "4.6s"}} />
                    <Ball style={{"--color": "#008B8B", "--i": "19px", "--d": "5.7s"}} />
                    <Ball style={{"--color": "#2F4F4F", "--i": "11px", "--d": "7.1s"}} />
                    <Ball style={{"--color": "#708090", "--i": "13px", "--d": "9.7s"}} />
                    <Ball style={{"--color": "#778899", "--i": "10px", "--d": "6.2s"}} />
                    <Ball style={{"--color": "#B0E0E6", "--i": "14px", "--d": "3.4s"}} />
                    <Ball style={{"--color": "#AFEEEE", "--i": "17px", "--d": "8.9s"}} />
                    <Ball style={{"--color": "#00CED1", "--i": "12px", "--d": "7.6s"}} />
                    <Ball style={{"--color": "#48D1CC", "--i": "16px", "--d": "4.3s"}} />
                    <Ball style={{"--color": "#40E0D0", "--i": "18px", "--d": "2.8s"}} />
                </ContainerLoader>
                
                <Title show={showTitle}>{actualName ? `${actualName}님의` : '당신의'} 첫 맞춤형 Clickwork 피빗이 태어났어요!</Title>
                <Subtitle show={showTitle}>
                    데스크탑 앞에 놓여있는 clickwork 모듈과의 대화를 통해<br/>
                    새로운 습관 개선 여정을 시작하세요
                </Subtitle>
