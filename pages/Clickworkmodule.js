...
const BackgroundGradient1 = styled.div`
  ...
  left: 52px;
  top: 1000px;
  background: linear-gradient(180deg, rgba(255, 255, 255, 0) 30%, #B3CAD8 100%);
...
const BackgroundGradient2 = styled.div`
  ...
  left: 915.94px;
  top: -428.99px;
  background: linear-gradient(270deg, #B3CAD8 0%, rgba(255, 255, 255, 0) 100%);
...
const InfoCard = styled.div`
  ...
  width: 281px;
  height: 150px;
  background: linear-gradient(180deg, #B3CAD8 0%, #FFFFFF 100%);
  opacity: 0.6;
...
export default function PuffyModulePage() {
    ...
    const line1 = 'Click-flex motion for rhythmic';
    const line2 = 'tension relief.';
            ...
            <main>
                <Root>
                    ...
                    <FiveFlowerBgText className={startTextAnimation ? 'animated' : ''}>
                        {'Clickwork'.split('').map((char, index) => (
                            <span key={`first-${index}`} style={{
                                animationDelay: `${0.1 * (index + 1)}s`,
                                marginRight: index === 4 ? '245px' : '0'
                            }}>
                                {char}
                            </span>
                        ))}
                    ...
                    <ModuleVersionText>Module 2nd Ver.</ModuleVersionText>
                    <FiveFlowerTitle>Clickwork</FiveFlowerTitle>
                    <Description className={startTextAnimation ? 'animated' : ''}>
                        사용자님께 'Clickwork Module'을 추천드려요!
                        <br />
