...
export default function PuffyProducePage() {
    ...
    return (
        <>
            <Head>
                <title>PIBIT - Puffy Produce</title>
            ...
            <Root>
                ...
                <ModelContainer show={showModel}>
                    <FlowerModelView onModelClick={handleStartConversation} modelPath="/puffy23.glb"/>
                </ModelContainer>
                ...
                <Title show={showTitle}>{name}님의 첫 맞춤형 Puffy 피빗이 태어났어요!</Title>
