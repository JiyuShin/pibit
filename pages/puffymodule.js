...
const Vector1 = styled.div`
  ...
  filter: blur(1.2px);
  opacity: 0;
  animation: fadeInVector1 1s ease-out 0.5s forwards, 
             ${rotateLeft} 10s linear infinite 1.5s;
  z-index: 1;
  
  @keyframes fadeInVector1 {
    from { opacity: 0; }
    to { opacity: 0.65; }
  }
`;
...
const SensoryReliefText = styled.div`
  position: absolute;
  left: calc(65.55% - 33px);
  right: calc(1.06% + 33px);
  top: calc(89.71% - 57px);
  bottom: calc(4.79% + 57px);
  font-family: 'Pretendard Variable', 'Pretendard', sans-serif;
  font-style: normal;
  font-weight: 500;
  font-size: 41.8px;
        ...
        <>
            ...
            <main>
                <Root>
                    ...
                    <ModuleVersionText>Module 6th Ver.</ModuleVersionText>
                    ...
                    <UserPreferenceDescription><span style={{ fontSize: '22px' }}>92%</span>의 유저가 턱 괴기 습관을<br/>개선하는데 이 모듈을 추천해요!</UserPreferenceDescription>
                    <CompanionTypeCard />
                    <CompanionTypeIcon />
                    ...
                    <SensoryReliefText className={startTextAnimation ? 'animated' : ''}>
                        <div style={{ whiteSpace: 'nowrap', display: 'flex', justifyContent: 'flex-end', width: '100%' }}>
